...
type Outbox struct {
	...
	Retained         *bool   `protobuf:"varint,10,opt,name=retained,def=0" json:"retained,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
const Default_Outbox_Retained bool = false
...
func (m *Outbox) GetRetained() bool {
	if m != nil && m.Retained != nil {
		return *m.Retained
	}
	return Default_Outbox_Retained
}
