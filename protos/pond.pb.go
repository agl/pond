...
type Message struct {
	...
	Introductions    []*Message_Introduction `protobuf:"bytes,11,rep,name=introductions" json:"introductions,omitempty"`
	XXX_unrecognized []byte                  `json:"-"`
}
...
func (m *Message) GetIntroductions() []*Message_Introduction {
	if m != nil {
		return m.Introductions
	}
	return nil
}
...
type Message_Introduction struct {
	// optional fixed64 id = 1;
	Name             *string `protobuf:"bytes,2,opt,name=name" json:"name,omitempty"`
	Identity         []byte  `protobuf:"bytes,3,opt,name=identity" json:"identity,omitempty"`
	PandaSecret      *string `protobuf:"bytes,4,opt,name=panda_secret" json:"panda_secret,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *Message_Introduction) Reset()         { *m = Message_Introduction{} }
func (m *Message_Introduction) String() string { return proto.CompactTextString(m) }
func (*Message_Introduction) ProtoMessage()    {}

func (m *Message_Introduction) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *Message_Introduction) GetIdentity() []byte {
	if m != nil {
		return m.Identity
	}
	return nil
...
func (m *Message_Introduction) GetPandaSecret() string {
	if m != nil && m.PandaSecret != nil {
		return *m.PandaSecret
	}
	return ""
}
